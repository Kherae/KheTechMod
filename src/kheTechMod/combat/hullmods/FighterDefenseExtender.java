...
public class FighterDefenseExtender extends BaseHullMod {
	...
	public String getUnapplicableReason(ShipAPI ship) {
		if (!KheUtilities.hasFighterBays(ship)) {
	...
	public void addPostDescriptionSection(TooltipMakerAPI tooltip, ShipAPI.HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
		...
		tooltip.addPara("Shield radius: %s\nShield turn rate: %s", opad, good,
				KheUtilities.lazyKheGetMultString(SHIELDBONUSES), KheUtilities.lazyKheGetMultString(SHIELDBONUSES)
		);
		...
		tooltip.addPara("Phase activation: %s\nPhase upkeep: %s", opad, good,
				KheUtilities.lazyKheGetMultString(PHASEBONUSES), KheUtilities.lazyKheGetMultString(PHASEBONUSES)
		);
