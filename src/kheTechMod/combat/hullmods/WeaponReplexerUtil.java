...
public class WeaponReplexerUtil extends BaseHullMod {
	...
	public static boolean isBeamMode() {
		return false;
	}
	...
	public void valueMath(String id, ShipAPI ship, float opMult, float penaltyMult) {
		valueMath(id, ship, opMult, opMult, opMult, penaltyMult, penaltyMult, penaltyMult);
	}
...
//	}
	...
	public String addRemoveReasonResolve(ShipAPI ship, String myID, MarketAPI marketOrNull) {
		...
		if (preventRemoveOrAdd(ship, myID, marketOrNull)) {
			return REPLEXERNOREMOVALSTRING + wouldRemovalPutOverLimit(myID, ship) + ".";
		}
		return null;
	}
